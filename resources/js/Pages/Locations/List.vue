                        ...
                        <div class="overflow-x-auto w-full">
                            ...
                            <tbody class="bg-base-100  " >
                                <tr v-for="location in locations" :key="location.id" class="transition duration-300 ease-in-out text-white hover:bg-neutral dark: bg-base-100 dark:hover:bg-base-100" >
                                    ...
                                    <td class="flex ">
                                    <Link :href="route('location.edit')" class="flex items-center bg-blue-500 hover:bg-blue-700 text-white font-semibold px-3 py-2 m-2 rounded" :data= "{id: location.id}" as="button" title="Edit Location" >
