  ...
  <div class="px-3 py-7 lg:px-5 lg:pl-3 ">
        <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 text-right h-full ">
                                <Link
                                ...
                                <template v-else>
                                    <div class="flex justify-between gap-4 h-full mt-5 mr-9  ">
                                    <button className="btn btn-outline btn-primary ">
                                    <Link class= "flex justify-center items-center gap-2" 
                                        :href="route('login')"
                                        >
